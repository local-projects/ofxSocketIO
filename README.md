...
If adding this addon to your own Windows Visual Studio 2019 project using OF's Project Generator, make sure to remove the `libs` folder in *Project Explorer* from *local_addons > ofxSocketIO > libs*.
